...
!(function (e, t) {
  ...
  function t(e, t, n) {
    Object.defineProperty(e, t, {
      ...
      set: function (e) {
        "RGB" !== this.__state.space && (V.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
          (this.__state[t] = e);
      }
    });
  }
  ...
  function o(e) {
    ...
    var t = e.match(G);
    return k.isNull(t) ? 0 : parseFloat(t[1]);
  }
  function i(e) {
    var t = e.toString();
  ...
  function c(e) {
    U.unbind(window, "resize", e.__resizeHandler),
      e.saveToLocalStorageIfPossible && U.unbind(window, "unload", e.saveToLocalStorageIfPossible);
  }
  function u(e, t) {
  ...
  function _(e, t, n) {
    if (
      ...
      k.extend(n, {
        options: function (t) {
          if (arguments.length > 1) {
            ...
            return n.remove(), p(e, n.object, n.property, { before: o, factoryArgs: [k.toArray(arguments)] });
          }
          if (k.isArray(t) || k.isObject(t)) {
            var i = n.__li.nextElementSibling;
            return n.remove(), p(e, n.object, n.property, { before: i, factoryArgs: [t] });
          }
        },
        name: function (e) {
      ...
      var o = new W(n.object, n.property, { min: n.__min, max: n.__max, step: n.__step });
      k.each(["updateDisplay", "onChange", "onFinishChange", "step"], function (e) {
        var t = n[e],
          i = o[e];
        n[e] = o[e] = function () {
      ...
      (n.min = k.compose(i, n.min)), (n.max = k.compose(i, n.max));
    } else
      n instanceof X
        ? (U.bind(t, "click", function () {
            U.fakeEvent(n.__checkbox, "click");
          }),
          U.bind(n.__checkbox, "click", function (e) {
            e.stopPropagation();
          }))
        : n instanceof q
        ? (U.bind(t, "click", function () {
            U.fakeEvent(n.__button, "click");
          }),
          U.bind(t, "mouseover", function () {
            U.addClass(n.__button, "hover");
          }),
          U.bind(t, "mouseout", function () {
            U.removeClass(n.__button, "hover");
          }))
        : n instanceof Z &&
          (U.addClass(t, "color"),
          (n.updateDisplay = k.compose(function (e) {
            return (t.style.borderLeftColor = n.__color.toString()), e;
          }, n.updateDisplay)),
          n.updateDisplay());
    n.setValue = k.compose(function (t) {
      return e.getRoot().__preset_select && n.isModified() && u(e.getRoot(), !0), t;
    }, n.setValue);
  }
  function h(e, t) {
    var n = e.getRoot(),
  ...
  function p(e, t, n, o) {
    ...
    var i = void 0;
    if (o.color) i = new Z(t, n);
    else {
      var r = [t, n].concat(o.factoryArgs);
      i = te.apply(e, r);
    }
    o.before instanceof I && (o.before = o.before.__li), h(e, i), U.addClass(i.domElement, "c");
    var s = document.createElement("span");
    U.addClass(s, "property-name"), (s.innerHTML = i.property);
    var a = document.createElement("div");
    a.appendChild(s), a.appendChild(i.domElement);
    var l = d(e, a, o.before);
    return (
      U.addClass(l, _e.CLASS_CONTROLLER_ROW),
      i instanceof Z ? U.addClass(l, "color") : U.addClass(l, N(i.getValue())),
      _(e, l, i),
  ...
  function b(e) {
    ...
    U.addClass(e.domElement, "has-save"), e.__ul.insertBefore(t, e.__ul.firstChild), U.addClass(t, "save-row");
    var n = document.createElement("span");
    (n.innerHTML = "&nbsp;"), U.addClass(n, "button gears");
    var o = document.createElement("span");
    (o.innerHTML = "Save"), U.addClass(o, "button"), U.addClass(o, "save");
    var i = document.createElement("span");
    (i.innerHTML = "New"), U.addClass(i, "button"), U.addClass(i, "save-as");
    var r = document.createElement("span");
    (r.innerHTML = "Revert"), U.addClass(r, "button"), U.addClass(r, "revert");
    var s = (e.__preset_select = document.createElement("select"));
    if (
      (e.load && e.load.remembered
        ? k.each(e.load.remembered, function (t, n) {
            m(e, n, n === e.preset);
          })
        : m(e, re, !1),
      U.bind(s, "change", function () {
      ...
      (document.getElementById("dg-save-locally").style.display = "block"),
        "true" === localStorage.getItem(f(e, "isLocal")) && l.setAttribute("checked", "checked"),
        g(e, a),
        U.bind(l, "change", function () {
          (e.useLocalStorage = !e.useLocalStorage), g(e, a);
        });
    }
    var d = document.getElementById("dg-new-constructor");
    U.bind(d, "keydown", function (e) {
      !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || ae.hide();
    }),
      U.bind(n, "click", function () {
        (d.innerHTML = JSON.stringify(e.getSaveObject(), void 0, 2)), ae.show(), d.focus(), d.select();
      }),
      U.bind(o, "click", function () {
        e.save();
      }),
  ...
  function v(e) {
    ...
    function n() {
      U.removeClass(e.__closeButton, _e.CLASS_DRAG), U.unbind(window, "mousemove", t), U.unbind(window, "mouseup", n);
    }
    function o(o) {
      return (
        o.preventDefault(),
        (i = o.clientX),
        U.addClass(e.__closeButton, _e.CLASS_DRAG),
    ...
    (e.__resize_handle = document.createElement("div")),
      ...
      U.bind(e.__resize_handle, "mousedown", o),
      U.bind(e.__closeButton, "mousedown", o),
  ...
  function w(e, t) {
    var n = {};
    return (
      k.each(e.__rememberedObjects, function (o, i) {
        var r = {},
          s = e.__rememberedObjectIndecesToControllers[i];
        k.each(s, function (e, n) {
  ...
  var C = Array.prototype.forEach,
    ...
    k = {
      ...
      each: function (e, t, n) {
        if (e)
          if (C && e.forEach && e.forEach === C) e.forEach(t, n);
      ...
      },
      {
        ...
        conversions: {
          ...
          RGB_OBJ: {
            read: function (e) {
              return (
                !!(k.isNumber(e.r) && k.isNumber(e.g) && k.isNumber(e.b)) && { space: "RGB", r: e.r, g: e.g, b: e.b }
              );
            },
            write: function (e) {
          ...
          HSV_OBJ: {
            read: function (e) {
              return (
                !!(k.isNumber(e.h) && k.isNumber(e.s) && k.isNumber(e.v)) && { space: "HSV", h: e.h, s: e.s, v: e.v }
              );
            },
            write: function (e) {
    ...
    R = function () {
      ...
      return (
        k.each(S, function (t) {
          if (t.litmus(e))
            return (
              k.each(t.conversions, function (t, n) {
                if (((O = t.read(e)), !1 === T && !1 !== O))
                  return (T = O), (O.conversionName = n), (O.conversion = t), k.BREAK;
              }),
              k.BREAK
            );
        }),
    ...
    V = (function () {
      function t() {
        if ((H(this, t), (this.__state = R.apply(this, arguments)), !1 === this.__state))
  ...
  (V.recalculateRGB = function (e, t, n) {
    if ("HEX" === e.__state.space) e.__state[t] = B.component_from_hex(e.__state.hex, n);
    else {
    ...
    Object.defineProperty(V.prototype, "hex", {
      get: function () {
        return (
          "HEX" !== !this.__state.space && (this.__state.hex = B.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex
        );
      },
      set: function (e) {
  ...
  var G = /(\d+(\.\d+)?)px/,
    ...
    X = (function (e) {
      function t(e, n) {
        H(this, t);
        var o = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
          i = o;
        return (
          (o.__prev = o.getValue()),
        ...
        F(t, [
          {
            key: "setValue",
            value: function (e) {
              var n = P(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setValue", this).call(this, e);
              return (
    ...
    K = (function (e) {
      function t(e, n, o) {
        ...
        var i = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
          r = o,
          s = i;
        if (((i.__select = document.createElement("select")), k.isArray(r))) {
          var a = {};
          k.each(r, function (e) {
            a[e] = e;
          }),
        ...
        return (
          ...
          i.updateDisplay(),
          U.bind(i.__select, "change", function () {
    ...
    Y = (function (e) {
      function t(e, n) {
        ...
        return (
          ...
          U.bind(i.__input, "keyup", o),
          U.bind(i.__input, "change", o),
          U.bind(i.__input, "blur", function () {
            r.__onFinishChange && r.__onFinishChange.call(r, r.getValue());
          }),
          U.bind(i.__input, "keydown", function (e) {
        ...
        F(t, [
          {
            ...
            value: function () {
              return (
                U.isActive(this.__input) || (this.__input.value = this.getValue()),
                P(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "updateDisplay", this).call(this)
              );
            }
          }
    ...
    J = (function (e) {
      function t(e, n, o) {
        H(this, t);
        var r = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
          s = o || {};
        return (
          (r.__min = s.min),
          (r.__max = s.max),
          (r.__step = s.step),
          k.isUndefined(r.__step)
            ? 0 === r.initialValue
              ? (r.__impliedStep = 1)
              : (r.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(r.initialValue)) / Math.LN10)) / 10)
            : (r.__impliedStep = r.__step),
          (r.__precision = i(r.__impliedStep)),
          r
        );
      }
      return (
        ...
        F(t, [
          {
            ...
            value: function (e) {
              ...
              return (
                ...
                P(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setValue", this).call(this, n)
              );
            }
          },
          {
    ...
    W = (function (e) {
      function t(e, n, o) {
        ...
        function s() {
          U.unbind(window, "mousemove", r), U.unbind(window, "mouseup", s), i();
        }
        H(this, t);
        var a = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, o));
        ...
        return (
          ...
          U.bind(a.__input, "change", function () {
            var e = parseFloat(l.__input.value);
            k.isNaN(e) || l.setValue(e);
          }),
          U.bind(a.__input, "blur", function () {
            i();
          }),
          U.bind(a.__input, "mousedown", function (e) {
            U.bind(window, "mousemove", r), U.bind(window, "mouseup", s), (d = e.clientY);
          }),
          U.bind(a.__input, "keydown", function (e) {
    ...
    Q = (function (e) {
      function t(e, n, o, i, r) {
        function a(e) {
          ...
          return _.setValue(s(e.clientX, t.left, t.right, _.__min, _.__max)), !1;
        }
        function l() {
          U.unbind(window, "mousemove", a),
            U.unbind(window, "mouseup", l),
            _.__onFinishChange && _.__onFinishChange.call(_, _.getValue());
        }
        function d(e) {
          var t = e.touches[0].clientX,
            n = _.__background.getBoundingClientRect();
          _.setValue(s(t, n.left, n.right, _.__min, _.__max));
        }
        function c() {
          U.unbind(window, "touchmove", d),
            U.unbind(window, "touchend", c),
            _.__onFinishChange && _.__onFinishChange.call(_, _.getValue());
        }
        H(this, t);
        var u = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, { min: o, max: i, step: r })),
          _ = u;
        return (
          (u.__background = document.createElement("div")),
          (u.__foreground = document.createElement("div")),
          U.bind(u.__background, "mousedown", function (e) {
            document.activeElement.blur(), U.bind(window, "mousemove", a), U.bind(window, "mouseup", l), a(e);
          }),
          U.bind(u.__background, "touchstart", function (e) {
            1 === e.touches.length && (U.bind(window, "touchmove", d), U.bind(window, "touchend", c), d(e));
          }),
          U.addClass(u.__background, "slider"),
          U.addClass(u.__foreground, "slider-fg"),
          u.updateDisplay(),
    ...
    q = (function (e) {
      function t(e, n, o) {
        ...
        return (
          ...
          U.bind(i.__button, "click", function (e) {
            return e.preventDefault(), r.fire(), !1;
          }),
          U.addClass(i.__button, "button"),
      ...
      function t(e, n) {
        function o(e) {
          u(e),
            ...
            U.bind(window, "touchmove", u),
            U.bind(window, "mouseup", r),
            U.bind(window, "touchend", r);
        }
        function i(e) {
          _(e),
            U.bind(window, "mousemove", _),
            U.bind(window, "touchmove", _),
            U.bind(window, "mouseup", s),
            U.bind(window, "touchend", s);
        }
        function r() {
          U.unbind(window, "mousemove", u),
            U.unbind(window, "touchmove", u),
            U.unbind(window, "mouseup", r),
            U.unbind(window, "touchend", r),
            c();
        }
        function s() {
          U.unbind(window, "mousemove", _),
            U.unbind(window, "touchmove", _),
            U.unbind(window, "mouseup", s),
            U.unbind(window, "touchend", s),
            c();
        }
        function d() {
          var e = R(this.value);
        ...
        H(this, t);
        var h = D(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
        (h.__color = new V(h.getValue())), (h.__temp = new V(0));
        var p = h;
        (h.domElement = document.createElement("div")),
          U.makeSelectable(h.domElement, !1),
          ...
          U.bind(h.__input, "keydown", function (e) {
            13 === e.keyCode && d.call(this);
          }),
          U.bind(h.__input, "blur", d),
          U.bind(h.__selector, "mousedown", function () {
            U.addClass(this, "drag").bind(window, "mouseup", function () {
              U.removeClass(p.__selector, "drag");
            });
          }),
          U.bind(h.__selector, "touchstart", function () {
        ...
        return (
          ...
          k.extend(h.__saturation_field.style, {
            width: "100px",
            height: "100px",
          ...
          k.extend(f.style, { width: "100%", height: "100%", background: "none" }),
          a(f, "top", "rgba(0,0,0,0)", "#000"),
          k.extend(h.__hue_field.style, {
            width: "15px",
            height: "100px",
            border: "1px solid #555",
            cursor: "ns-resize",
          ...
          U.bind(h.__saturation_field, "mousedown", o),
          U.bind(h.__saturation_field, "touchstart", o),
          U.bind(h.__field_knob, "mousedown", o),
          U.bind(h.__field_knob, "touchstart", o),
          U.bind(h.__hue_field, "mousedown", i),
          U.bind(h.__hue_field, "touchstart", i),
        ...
        F(t, [
          {
            ...
            value: function () {
              ...
              if (!1 !== e) {
                ...
                k.each(
                  ...
                  function (n) {
                    if (
                      !k.isUndefined(e[n]) &&
                      !k.isUndefined(this.__color.__state[n]) &&
              ...
              k.extend(this.__field_knob.style, {
                ...
                (this.__temp.s = 1),
                (this.__temp.v = 1),
                a(this.__saturation_field, "left", "#fff", this.__temp.toHexString()),
    ...
    te = function (e, t) {
      ...
      return k.isArray(arguments[2]) || k.isObject(arguments[2])
        ...
        ? k.isNumber(arguments[2]) && k.isNumber(arguments[3])
          ...
          : k.isNumber(arguments[4])
          ? new W(e, t, { min: arguments[2], max: arguments[3], step: arguments[4] })
          : new W(e, t, { min: arguments[2], max: arguments[3] })
        : k.isString(n)
        ? new Y(e, t)
        : k.isFunction(n)
        ? new q(e, t, "")
      ...
      return (
        F(e, [
              ...
              var e = this,
                t = function t() {
                  (e.domElement.style.display = "none"),
                    ...
                    U.unbind(e.domElement, "webkitTransitionEnd", t),
                    U.unbind(e.domElement, "transitionend", t),
                    U.unbind(e.domElement, "oTransitionEnd", t);
                };
              U.bind(this.domElement, "webkitTransitionEnd", t),
                U.bind(this.domElement, "transitionend", t),
                U.bind(this.domElement, "oTransitionEnd", t),
          ...
          },
          {
            key: "layout",
            value: function () {
              (this.domElement.style.left = window.innerWidth / 2 - U.getWidth(this.domElement) / 2 + "px"),
                (this.domElement.style.top = window.innerHeight / 2 - U.getHeight(this.domElement) / 2 + "px");
            }
          }
        ]),
        e
  ...
  var re = "Default",
    ...
    _e = function e(t) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        U.addClass(this.domElement, "dg"),
        (this.__folders = {}),
        (this.__controllers = []),
        (this.__rememberedObjects = []),
        (this.__rememberedObjectIndecesToControllers = []),
        (this.__listening = []),
        (o = k.defaults(o, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH })),
        (o = k.defaults(o, { resizable: o.autoPlace, hideable: o.autoPlace })),
        k.isUndefined(o.load) ? (o.load = { preset: re }) : o.preset && (o.load.preset = o.preset),
        k.isUndefined(o.parent) && o.hideable && ue.push(this),
        (o.resizable = k.isUndefined(o.parent) && o.resizable),
        o.autoPlace && k.isUndefined(o.scrollable) && (o.scrollable = !0);
      var i = se && "true" === localStorage.getItem(f(this, "isLocal")),
        r = void 0;
      if (
        (Object.defineProperties(this, {
          ...
          preset: {
            ...
            set: function (e) {
              n.parent ? (n.getRoot().preset = e) : (o.load.preset = e), x(this), n.revert();
            }
          },
          width: {
            get: function () {
          ...
          closed: {
            ...
            set: function (t) {
              (o.closed = t),
                o.closed ? U.addClass(n.__ul, e.CLASS_CLOSED) : U.removeClass(n.__ul, e.CLASS_CLOSED),
                this.onResize(),
          ...
          useLocalStorage: {
            ...
            set: function (e) {
              se &&
                ((i = e),
                e ? U.bind(window, "unload", r) : U.unbind(window, "unload", r),
                localStorage.setItem(f(n, "isLocal"), e));
            }
          }
        }),
        k.isUndefined(o.parent))
      ) {
        if (
          ((o.closed = !1), U.addClass(this.domElement, e.CLASS_MAIN), U.makeSelectable(this.domElement, !1), se && i)
        ) {
          n.useLocalStorage = !0;
          var s = localStorage.getItem(f(this, "gui"));
          s && (o.load = JSON.parse(s));
        }
        (this.__closeButton = document.createElement("div")),
          (this.__closeButton.innerHTML = e.TEXT_CLOSED),
          U.addClass(this.__closeButton, e.CLASS_CLOSE_BUTTON),
          o.closeOnTop
            ? (U.addClass(this.__closeButton, e.CLASS_CLOSE_TOP),
              this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0]))
            : (U.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)),
        ...
        U.addClass(a, "controller-name");
        var l = d(n, a);
        U.addClass(this.__ul, e.CLASS_CLOSED),
          U.addClass(l, "title"),
          U.bind(l, "click", function (e) {
      ...
      o.autoPlace &&
        (k.isUndefined(o.parent) &&
          (le &&
            ...
            U.addClass(de, "dg"),
            U.addClass(de, e.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(de),
            (le = !1)),
          de.appendChild(this.domElement),
          U.addClass(this.domElement, e.CLASS_AUTO_PLACE)),
        this.parent || y(n, o.width)),
        ...
        (r = function () {
          se &&
            "true" === localStorage.getItem(f(n, "isLocal")) &&
            localStorage.setItem(f(n, "gui"), JSON.stringify(n.getSaveObject()));
        }),
  ...
  return (
    (_e.toggleHide = function () {
      (ce = !ce),
        k.each(ue, function (e) {
          e.domElement.style.display = ce ? "none" : "";
        });
    }),
    (_e.CLASS_AUTO_PLACE = "a"),
    (_e.CLASS_AUTO_PLACE_CONTAINER = "ac"),
    (_e.CLASS_MAIN = "main"),
    (_e.CLASS_CONTROLLER_ROW = "cr"),
    (_e.CLASS_TOO_TALL = "taller-than-window"),
    (_e.CLASS_CLOSED = "closed"),
    (_e.CLASS_CLOSE_BUTTON = "close-button"),
    (_e.CLASS_CLOSE_TOP = "close-top"),
    (_e.CLASS_CLOSE_BOTTOM = "close-bottom"),
    (_e.CLASS_DRAG = "drag"),
    (_e.DEFAULT_WIDTH = 245),
    (_e.TEXT_CLOSED = "Close Controls"),
    (_e.TEXT_OPEN = "Open Controls"),
    (_e._keydownHandler = function (e) {
      "text" === document.activeElement.type || (72 !== e.which && 72 !== e.keyCode) || _e.toggleHide();
    }),
    U.bind(window, "keydown", _e._keydownHandler, !1),
    k.extend(_e.prototype, {
      add: function (e, t) {
      ...
      destroy: function () {
        ...
        k.each(this.__folders, function (t) {
          ...
          U.unbind(window, "keydown", _e._keydownHandler, !1),
          c(this);
      },
      addFolder: function (e) {
        ...
        var n = new _e(t);
        this.__folders[e] = n;
        var o = d(this, n.domElement);
        return U.addClass(o, "folder"), n;
      },
      ...
      onResize: function () {
        ...
        if (e.scrollable) {
          var t = U.getOffset(e.__ul).top,
            n = 0;
          k.each(e.__ul.childNodes, function (t) {
            (e.autoPlace && t === e.__save_row) || (n += U.getHeight(t));
          }),
            window.innerHeight - t - 20 < n
              ? (U.addClass(e.domElement, _e.CLASS_TOO_TALL),
                (e.__ul.style.height = window.innerHeight - t - 20 + "px"))
              : (U.removeClass(e.domElement, _e.CLASS_TOO_TALL), (e.__ul.style.height = "auto"));
        }
        e.__resize_handle &&
          k.defer(function () {
      ...
      remember: function () {
        if (
          (k.isUndefined(ae) &&
            ((ae = new oe()).domElement.innerHTML =
        ...
        k.each(Array.prototype.slice.call(arguments), function (t) {
          0 === e.__rememberedObjects.length && b(e),
      ...
      getSaveObject: function () {
        ...
        return (
          ...
          this.__rememberedObjects.length > 0 &&
            ((e.preset = this.preset), e.remembered || (e.remembered = {}), (e.remembered[this.preset] = w(this))),
          (e.folders = {}),
          k.each(this.__folders, function (t, n) {
      ...
      saveAs: function (e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[re] = w(this, !0))),
          (this.load.remembered[e] = w(this)),
          (this.preset = e),
          m(this, e, !0),
          this.saveToLocalStorageIfPossible();
      },
      revert: function (e) {
        k.each(
          this.__controllers,
          function (t) {
            this.getRoot().load.remembered ? h(e || this.getRoot(), t) : t.setValue(t.initialValue),
    ...
    {
      color: { Color: V, math: B, interpret: R },
      controllers: {
        Controller: I,
        BooleanController: X,
        OptionController: K,
