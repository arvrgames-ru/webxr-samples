import { Float32ArrayOrArray, Vector3Array } from "../../../../../interfaces";
...
export function clone(a) {
  const out: Float32ArrayOrArray = new glMatrix.ARRAY_TYPE(3);
  out[0] = a[0];
  out[1] = a[1];
  out[2] = a[2];
  return out;
...
export function fromValues(x: number, y: number, z: number) {
  const out: number[] | Float32Array = new glMatrix.ARRAY_TYPE(3);
  out[0] = x;
  out[1] = y;
  out[2] = z;
  return out;
 ...
 * @returns {vec3} out
 */
export function rotateX(out: Vector3Array, a, b, c) {
  const p: number[] = [],
    r: number[] = [];
 ...
 * @returns {vec3} out
 */
export function rotateY(out: Vector3Array, a, b, c) {
  const p: number[] = [],
    r: number[] = [];
  //Translate point to the origin
  p[0] = a[0] - b[0];
 ...
 * @returns {vec3} out
 */
export function rotateZ(out: Vector3Array, a, b, c) {
  const p: number[] = [],
    r: number[] = [];
  //Translate point to the origin
  p[0] = a[0] - b[0];
